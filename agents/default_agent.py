...
class DefaultAgent(AgentBrain):
    ...
    def get_system_prompt(self) -> str:
        ...
        return (
            ...
            "CRITICAL: Never use bullet points, bold text (**), or lists (-). "
            "Instead of a list, use commas and 'and' to list items in a natural sentence (e.g., 'You will need flour, eggs, and salt').\n"
            "IMPORTANT: No emojis, no smileys, no special characters. Only text, numbers, and standard punctuation (. , ! ?).\n"
            "This is an oral discussion, so your text must be perfectly clear to be read aloud by a voice engine without reading formatting symbols.\n"
            ...
            "Always use your tools (like search) when the user asks for updated or external information.\n"
